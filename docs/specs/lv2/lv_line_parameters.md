# Known LV Line Parameters Specification - LV Network 2
...
Lines `down_2_1` through `down_2_24` connect known buses `feeder2_sec`, `f2_node1` ... `f2_node24` with specified lengths (0.05 to 0.10 km) capable of supporting peak consumer loads under 350 A thermal rating per phase.
